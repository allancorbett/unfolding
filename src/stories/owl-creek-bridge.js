...
export const tree = [
    ...
    G("planter", "Southern planter named Peyton Farquhar", [
      ...
      G("farquhar", "Peyton Farquhar, slaveholder and secessionist", [
        ...
        G("ardent", "ardent for the Confederate cause", [
          T("ardent for the Confederate cause, kept from the army by imperious circumstance he need not be told"),
        ]),
      ]),
    ]),
  ]),
  T(" "),
  G("stands", "stands on a bridge", [
    T(" stands "),
  ...
  G("hanged", "to be hanged,", [
    T(", "),
    G("flanked", "flanked by silent Federal soldiers", [
    ...
    G("captured", "having been caught attempting to burn the bridge", [
      T("having been caught the night before "),
      G("scout", "by a Federal scout in grey", [
  ...
  G("dreams", "imagines a daring escape", [
    ...
    G("swam", "swam beneath the bullets", [
      ...
      G("bullets", "bullets whipped the water all about him", [
    ...
    G("downstream", "far downstream into the silent woods", [
      T("a mile downstream and flung up at last on a "),
      G("sand", "bank of golden sand", [
        T("bank of golden sand, where each grain glittered like a jewel and each leaf above shone with strange and magical colour"),
      ]),
    ]),
    T(", whence he set out "),
  ...
  G("hangs", "as he is hanged.", [
    ...
    G("blow", "a stunning blow upon the back of his neck", [
      ...
      G("dazzling", "a blinding white flash all about him", [
