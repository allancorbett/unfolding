...
export const tree = [
  ...
  G("entertains", "entertains a nervous visitor", [
    ...
    G("framton", "highly nervous visitor named Framton Nuttel", [
      ...
      G("rural-cure", "come to the country for his nerve cure", [
        T("come from town to the country for a "),
  ...
  G("tells", "with a tragic tale,", [
    ...
    G("explains", "tells him in a low, confidential voice", [
      T("tells him in a low, confidential voice that he must forgive her aunt for keeping the "),
    ...
    G("husband", "her husband and her two young brothers", [
      ...
      G("shooting", "went out shooting on the moor", [
        ...
        G("never-returned", "and never came back again", [
          T("and never came back — "),
          G("bog", "the wet bog of that summer swallowed them up", [
    ...
    G("walking", "walking in by that window as they used to", [
      T("walking in by that very window as they always used to do, "),
      G("with-dog", "with their little brown spaniel running on ahead", [
  ...
  G("flees", "and frightens him away.", [
    ...
    G("vera-stares", "Vera staring out into the dusk in dawning horror", [
      T("Vera staring out through the open window in dawning horror"),
    ]),
    T(". He turned, and "),
    G("three-figures", "three figures came walking across the lawn", [
      ...
      G("guns", "all carrying guns under their arms", [
    ...
    G("explains-after", "in her quiet voice, supplied the explanation", [
      ...
      G("hyena", "told a tale of pariah dogs on the Ganges", [
