...
export const tree = [
  G("woman", "A woman", [
    ...
    G("young-wife", "young wife of nervous disposition", [
      T("young wife of "),
      G("nervous", "nervous and imaginative disposition", [
        T("nervous and imaginative disposition, "),
  ...
  G("shut", "is shut", [
    T("is "),
    G("by-husband", "shut up by her husband", [
      ...
      G("rest-cure", "for the celebrated rest cure", [
        ...
        G("forbidden", "forbidden any work or company", [
          ...
          G("john-laughs", "while he laughs at her fancies", [
  ...
  G("mad", "and slowly loses her mind.", [
    ...
    G("watches", "watches the wallpaper for hours", [
      ...
      G("sees-pattern", "until she begins to see a pattern within the pattern", [
        T("until she begins to see, behind the front design, "),
        G("woman-behind", "a woman creeping behind the bars", [
          T("a woman, stooping and creeping, shaking the bars of the outer pattern as if she meant to climb through"),
        ]),
      ]),
    ]),
    T(". By moonlight "),
    G("by-moon", "the woman behind grows clearer", [
      ...
      G("creeps", "and at last creeps about the room by day", [
    ...
    G("strips", "she strips the paper from the walls", [
      ...
      G("tearing", "and spends the night tearing the paper down in long damp strips", [
        ...
        G("freed", "to free the woman trapped behind", [
          T("to free the woman she is sure is trapped behind it"),
        ]),
      ]),
    ]),
